...
public class CustomerController {
	...
	//Add customer functionality -  On submit of customer form below method will be called
	...
	//Search customer functionality -  On search customer form with option to enter an customer id is displayed
	...
	//Search customer functionality -  On submit of search customer form below method will be called
